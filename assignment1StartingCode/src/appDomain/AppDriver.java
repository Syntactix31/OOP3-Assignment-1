	...
	public class AppDriver
	{
		...
		public static void main( String[] args )
		{
			...
			// Insertion Sort Benchmarking (Replace test array with array from file read parse)
			start = System.currentTimeMillis();
	        InsertionSort newArray2 = new InsertionSort();
	        
	        double[] testArray3 = {15.445, 8.234, 5.679, 5.78, 11.3};
	        System.out.println("Original Array: ");
	        
	        for (double val : testArray3) {
	            System.out.println(val);
	        }
	        ...
	        System.out.println("Sorted Array: ");
	        newArray2.sort(testArray3);
	        
	        for (double numbers : testArray3) {
	            System.out.println(numbers);
	        }
			...
			// Shell Sort Benchmarking (Replace test array with array from file read parse)
			start = System.currentTimeMillis();
	        ShellSort newArray3 = new ShellSort();
	        
	        double[] testArray4 = {15.445, 8.234, 5.679, 5.78, 11.3, 8.234};
	        System.out.println("Original Array: ");
	        
	        for (double val : testArray4) {
	            System.out.println(val);
	        }
	        ...
	        System.out.println("Sorted Array: ");
	        newArray3.sort(testArray4);
	        
	        for (double numbers : testArray4) {
	            System.out.println(numbers);
	        }
